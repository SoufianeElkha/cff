...
extern void gfx_drawline(struct gfx_context_t *ctxt, int x1, int y1, int x2, int y2, uint32_t color);
extern void gfx_drawrect(struct gfx_context_t *ctxt, int x, int y, int width, int height, uint32_t color);
